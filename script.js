...
const EMOTES = {
    // --- КЛАССИКА И СМЕХ ---
    "Kappa": "https://cdn.7tv.app/emote/01H5ZZQ0X8000797KPJXA8Y5X4/4x.avif",
    "kappa": "https://cdn.7tv.app/emote/01FDQVFW9R000BR3XSTR5SRRTX/4x.avif",
    "LUL": "https://cdn.7tv.app/emote/01GEBDC57000074FSP5ZB2BJFG/4x.avif",
    "LULW": "https://cdn.7tv.app/emote/01F22WE74G000F9Q0G00A2DE8N/4x.avif",
    "KEKW": "https://cdn.7tv.app/emote/01F61B1440000991F7SWQNMVX7/4x.avif",
    "kekw": "https://cdn.7tv.app/emote/01FT45KDR0000CS587T97X9SYS/4x.avif",

    // --- РАДОСТЬ, УСПЕХ, УДИВЛЕНИЕ ---
    "Pog": "https://cdn.7tv.app/emote/01FTS5QQC00009YYXC2F22VHBG/4x.avif",
    "pog": "https://cdn.7tv.app/emote/01G3KYTKXR000ET2J0MQP5Y06S/4x.avif",
    "PogU": "https://cdn.7tv.app/emote/01F6F20SGG0001B89K8BE2K372/4x.avif",
    "PogChamp": "https://cdn.7tv.app/emote/01FD0HZD2G0009QXBMY7YYTYK3/4x.avif",
    "EZ": "https://cdn.7tv.app/emote/01G06Y4XNR0008WN11V1V5AHED/4x.avif",
    "ez": "https://cdn.7tv.app/emote/01F9FS6EEG0006XXD6DX0K9Y04/4x.avif",
    "W": "https://cdn.7tv.app/emote/01GM9KFF4G000BYX6NYFV0K5MZ/4x.avif", 
    "GIGACHAD": "https://cdn.7tv.app/emote/01F6MZGCNG000255K4X1K7NTHR/4x.avif",
    "5Head": "https://cdn.7tv.app/emote/01FB4NYBG0000FFZEHGR5A0DYS/4x.avif", // Для умных мувов

    // --- ГРУСТЬ, СОЧУВСТВИЕ, ПОРАЖЕНИЕ ---
    "Sadge": "https://cdn.7tv.app/emote/01FER5EZD80005F8W3D6FPGFR8/4x.avif",
    "PepeHands": "https://cdn.7tv.app/emote/01F010G3WG0007E4VV006YKSKP/4x.avif",
    "F": "https://cdn.7tv.app/emote/01J92ZCSM80001V26HAKQBET0C/4x.avif", 
    "L": "https://cdn.7tv.app/emote/01JR9K9P2PEVZ4P78498QWPZEW/4x.avif",
    "Despair": "https://cdn.7tv.app/emote/01G5MJTFVG000AM0RPEKKRC0TH/4x.avif",

    // --- СТРАХ, НАПРЯЖЕНИЕ, ШОК ---
    "monkaS": "https://cdn.7tv.app/emote/01FFS2HWMR0007P57XYW0BJDZM/4x.avif",
    "monkaW": "https://cdn.7tv.app/emote/01F71S8MF0000CGWD8KWAH6S2E/4x.avif",
    "monkaGIGA": "https://cdn.7tv.app/emote/01F6P9FQZ80009HVYB9XMM22RQ/4x.avif",
    "Aware": "https://cdn.7tv.app/emote/01FMGCX138000D6HG894PC6KG6/4x.avif", // Осознание ужаса

    // --- ТАНЦЫ И ВАЙБ (Идеально для категории Музыка) ---
    "catJAM": "https://cdn.7tv.app/emote/01F6MQ33FG000FFJ97ZB8MWV52/4x.avif",
    "pepeJAM": "https://cdn.7tv.app/emote/01EZY967K0000CYST6006V20T8/4x.avif",
    "VIBE": "https://cdn.7tv.app/emote/01FYQZVG280006SX8JX4TD7SJA/4x.avif",

    // --- РАЗНОЕ / АНИМЕ ---
    "AYAYA": "https://cdn.7tv.app/emote/01F8CTQCZ800099FQVFJ9XQRM1/4x.avif",
    "Clueless": "https://cdn.7tv.app/emote/01FHV34FV80005Q2VTPSMHZ22B/4x.avif", // Ничего не понимает
    "Sus": "https://cdn.7tv.app/emote/01HEKHE1MG0006REJ2K5EAP1N2/4x.avif",      // Подозрительно
    "Copium": "https://cdn.7tv.app/emote/01F6ME7ADR0000WDA7ERT9H30R/4x.avif"    // Когда зрители надеются на чудо
};
// ОБЩИЕ СООБЩЕНИЯ (С вшитыми эмодзи)
const GENERAL_MSGS = [
    "Pog", "PogU", "LULW", "KEKW", "F", "1", "???", "W", "L", "monkaS", "monkaW", 
    "gg", "база", "жиза KEKW", "Омегалул", "kappa", "drop fps", "привет стрим", 
    "Sadge", "PepeHands", "GIGACHAD", "+rep", "ez", "EZ",
    "ахаха LULW", "согласен GIGACHAD", "что происходит monkaS", "стример гений Pog",
    "ну такое Kappa", "понимаю Sadge", "F в чат", "Aware", "AYAYA", "Clueless"
];
// КАТЕГОРИИ (РОВНО ПО 35 СООБЩЕНИЙ: 20 чистых / 10 с эмодзи / 5 спам)
const CATEGORY_MSGS = {
  "Общение": [
      // 📝 20 чистого текста
      "что обсуждаем?", "расскажи историю", "когда игры?", "читай чат", "какие планы на сегодня?",
      "привет чатик", "как погода?", "а что за трек играет?", "кто откуда смотрит?", "какой микрофон?", 
      "какая мотивация!", "ARCHETYPE SYSTEM 🔥", "вдохновляет", "запись будет?", "есть кто из Норвегии?",
      "сделай тутор по выпечке", "какой у тебя дашборд?", "покажи свои таблицы", "крутой лук", "какой сейчас час?",
      // 🖼️ 10 текст + смайл
      "согласен GIGACHAD", "ахаха LULW", "осуждаю monkaS", "ура стрим catJAM", "почему игноришь? Sadge",
      "наконец-то подруб! PogU", "стример гений 5Head", "понимаю Aware", "база GIGACHAD", "жиза KEKW",
      // 🐸 5 только смайлы
      "KEKW", "LULW", "PogU", "pepeJAM", "GIGACHAD"
  ],
  
  "Реакции": [
      // 📝 20 чистого текста
      "включай следующее", "зацени мой видос", "ставь на паузу, давай обсудим", "перемотай на 5:20", 
      "он не понял шутки", "смотри до конца", "лучший формат", "что за кринж?", "я сейчас умру от смеха", 
      "давай дальше", "скинул ссылку в донат", "где ты это нашел?", "youtube алгоритмы топ", "он реально это сказал?", 
      "пересматриваю 10 раз", "это постановка", "да ладно?", "кто это вообще такой?", "я бы так же сделал", "остановите планету",
      // 🖼️ 10 текст + смайл
      "ахахаха реакция топ LULW", "осуждаю monkaS", "я тоже так реагировал KEKW", "это бан Aware", "F каналу LULW", 
      "гениально 5Head", "чат летит Pog", "остановите его KEKW", "минус уши WutFace", "ну такое Kappa",
      // 🐸 5 только смайлы
      "LULW", "KEKW", "Aware", "WutFace", "Pog"
  ],
  
  "Фильмы и Сериалы": [
      // 📝 20 чистого текста
      "без спойлеров!", "кто убийца?", "что за фильм?", "а какая это серия?", "не подсказывайте", 
      "попкорн взял", "озвучка топ", "режиссер гений", "шедевр", "как тебе актер?", 
      "надо тоже посмотреть", "когда следующий сезон?", "книга лучше", "затянуто немного", "вот это поворот", 
      "это детектив?", "крутой плот-твист", "я догадался на 20 минуте", "какой рейтинг на кинопоиске?", "переоценено",
      // 🖼️ 10 текст + смайл
      "я смотрел, концовка топ PogU", "напряженный момент monkaW", "я испугался monkaS", "F герою Sadge", "этот чел просто GIGACHAD", 
      "слишком темно WutFace", "жду экшен Pog", "ахах что за спецэффекты LULW", "сюжетная броня Kappa", "лучший дуэт AYAYA",
      // 🐸 5 только смайлы
      "monkaS", "monkaW", "Pog", "Aware", "Sadge"
  ],
  
  "Работа и Кодинг": [
      // 📝 20 чистого текста
      "что пишем?", "какой язык?", "ошибка на 42 строке", "кодим вместе", "почему не питон?", 
      "какой фреймворк?", "что за клавиатура? так клацает", "ARCHETYPE SYSTEM в деле", "идеально для фона", "Google Apps Script?", 
      "автоматизация топ", "сколько времени ушло на проект?", "сохранись", "где код посмотреть?", "почему не работает?",
      "пишем макросы?", "The Detective OS?", "как прокачать логику?", "покажи архитектуру", "снова таблицы?",
      // 🖼️ 10 текст + смайл
      "почему не темная тема? WutFace", "сколько платят? Kappa", "работягам привет GIGACHAD", "помоги с багом Sadge", "+ вайб catJAM", 
      "забыл точку с запятой LULW", "копипаст со StackOverflow KEKW", "кодинг это боль Aware", "мозг кипит monkaS", "стример хакер 5Head",
      // 🐸 5 только смайлы
      "5Head", "GIGACHAD", "Sadge", "catJAM", "Aware"
  ],
  
  "ASMR": [
      // 📝 20 чистого текста
      "тссс", "я сплю", "звук клавиатуры каеф", "сделай ушко", "очень расслабляет", 
      "спасибо за стрим, доброй ночи", "закрываю глаза", "то что нужно после работы", "какой микрофон?", "постучи по столу", 
      "шепот успокаивает", "можно без разговоров?", "визуальные триггеры", "tingles", "звук дождя добавишь?",
      "хруст макаронс?", "звуки готовки на кухне?", "пошурши бумагой", "дыши ровнее", "гипноз",
      // 🖼️ 10 текст + смайл
      "мурашки Pog", "уснул Zzz", "вайб VIBE", "сделай погромче AYAYA", "кот спит рядом catJAM", 
      "релакс GIGACHAD", "засыпаю Sadge", "очень тихо WutFace", "идеально для фона PogU", "кааааайф VIBE",
      // 🐸 5 только смайлы
      "Zzzzz", "VIBE", "Pog", "AYAYA", "catJAM"
  ],
  
  "IRL": [
      // 📝 20 чистого текста
      "где ты?", "какая погода?", "покажи вокруг", "что по связи?", "купи шаурму", 
      "какая камера?", "красивый вид", "куда идем?", "атмосферно на улице", "в Норвегии сейчас так?", 
      "холодно там?", "кто это с тобой?", "осторожно машины", "какой город?", "пойдем в магазин",
      "крутой лук", "стиль Y2K?", "покажи кроссовки", "Осло?", "солнце вышло",
      // 🖼️ 10 текст + смайл
      "интернет лагает Sadge", "F connection LULW", "люди смотрят ахах KEKW", "IRL pog", "стрим с телефона? 5Head", 
      "солнце слепит WutFace", "красиво жить не запретишь GIGACHAD", "осуждаю погоду monkaS", "пейзаж топ PogU", "беги monkaW",
      // 🐸 5 только смайлы
      "Pog", "LULW", "Sadge", "monkaW", "KEKW"
  ],
  
  "Counter-Strike": [
      // 📝 20 чистого текста
      "какой ранг?", "найс трай", "пушь его!", "раш б", "эко раунд", 
      "дай кфг", "какой прицел?", "сенса какая?", "репорт", "наушники сними", 
      "инфа есть?", "дропни авп", "тайминг", "как он попал?", "где тимейты?",
      "карта мираж?", "смок в окно", "флешка кривая", "сейви пушку", "он один остался",
      // 🖼️ 10 текст + смайл
      "ракуешь LULW", "читы оффни monkaS", "скилл ишью KEKW", "nice spray Pog", "катка слита Sadge", 
      "VAC 5Head", "gg wp GIGACHAD", "аим бот Kappa", "в спину! Aware", "затащил клатч PogU",
      // 🐸 5 только смайлы
      "EZ", "ez", "L", "F", "GIGACHAD"
  ],
  ...
  "Dota 2": [
      // 📝 20 чистого текста
      "репорт мидера", "где варды", "пуш мид", "какой ммр?", "дай сборку", 
      "пуш тавер", "хилься", "тп на топ", "рошан", "аегис чей?", 
      "почему без бкб?", "качай первый скилл", "нет маны", "соло килл", "идем в смоках",
      "крипстат?", "купи даггер", "байбек есть?", "зафокусьте сапорта", "трон падает",
      // 🖼️ 10 текст + смайл
      "ливни плз KEKW", "хорош PogU", "тима раков Sadge", "рошан monkaS", "зачем туда пошел? Aware", 
      "керри тащит GIGACHAD", "gg wp EZ", "мидер руинит LULW", "ошибка ценой в игру Kappa", "камбек? Copium",
      // 🐸 5 только смайлы
      "GG", "EZ", "LULW", "Sadge", "Copium"
  ],
  
  "Кино": [
      // 📝 20 чистого текста
      "это кино?", "визуал топ", "какая камера?", "режиссер хорош", "свет топ", 
      "композиция 10/10", "атмосфера просто космос", "это шедевр", "как ставили свет?", "цветокоррекция огонь", 
      "какой объектив?", "в стиле нуар", "мрачно, мне нравится", "шикарный кадр", "THE WARDEN?",
      "это Страж?", "кто писал сценарий?", "кадры с дрона?", "похоже на Бегущего по лезвию", "идеальные тени",
      // 🖼️ 10 текст + смайл
      "цветокор секс GIGACHAD", "Neo-noir vibe VIBE", "очень глубоко Aware", "меланхолия... Sadge", "отсылка к THE WARDEN? PogU", 
      "это артхаус 5Head", "слишком красиво Pog", "свет решает всё GIGACHAD", "атмосфера давит monkaS", "ARCHETYPE стиль VIBE",
      // 🐸 5 только смайлы
      "PogU", "GIGACHAD", "Aware", "VIBE", "Pog"
  ],
  
  "Музыка": [
      // 📝 20 чистого текста
      "что за трек?", "shazam plx", "VOLUME UP", "дай плейлист", "сделай погромче", 
      "уши кайфуют", "кто исполнитель?", "бит просто разнос", "добавь басов", "есть на Spotify?", 
      "lo-fi радио?", "синты топ", "оркестр?", "когда свой трек?", "очень атмосферно",
      "космический эмбиент", "Hans Zimmer?", "эпично звучит", "хор на фоне?", "музыка для битвы",
      // 🖼️ 10 текст + смайл
      "Drop the bass catJAM", "вайб VIBE", "качает pepeJAM", "кинематографично PogU", "мурашки от звука Aware", 
      "саундтрек к жизни GIGACHAD", "минус уши WutFace", "слишком грустно Sadge", "Ханс Циммер курит в сторонке 5Head", "танцуем catJAM",
      // 🐸 5 только смайлы
      "catJAM", "pepeJAM", "VIBE", "Pog", "AYAYA"
  ]
};
...
function triggerRaid() {
    ...
    if(audio) {
        ...
        audio.src = "https://www.myinstants.com/media/sounds/taco-bell-bong-sfx.mp3"; 
        audio.currentTime = 0;
        audio.play().catch(e => {});
...
function triggerSubscription() {
    ...
    if(audio) {
        if (window.audioStopTimer) clearTimeout(window.audioStopTimer);
        audio.src = "https://www.myinstants.com/media/sounds/applepay.mp3"; 
        audio.currentTime = 0;
        audio.play().catch(e => {});
