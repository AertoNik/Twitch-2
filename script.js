...
// КАТЕГОРИИ (РОВНО ПО 30 СООБЩЕНИЙ В КАЖДОЙ ДЛЯ МАКСИМАЛЬНОГО РЕАЛИЗМА)
const CATEGORY_MSGS = {
  "Общение": [
      // 📝 15 чистого текста
  ...
  "Реакции": [
      ...
      "давай дальше", "скинул ссылку в донат", "где ты это нашел?", "youtube алгоритмы топ", "он реально это сказал?", "пересматриваю 10 раз",
      // 🖼️ 10 текст + смайл
